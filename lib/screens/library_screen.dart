...
class _LibraryScreenState extends State<LibraryScreen> {
  ...
  Future<void> _openMagazine(Book book) async {
    ...
    try {
      ...
      final magazine = await service.getMagazineByName(magazineName);
