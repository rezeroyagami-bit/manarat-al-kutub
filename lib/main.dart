          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(config.appVersion, textAlign: TextAlign.center, style: const TextStyle(fontFamily: 'Amiri', fontSize: 14, color: Colors.black45)),
                const SizedBox(height: 14),
                const Text('نوستالجيا الكتب.. استنشق عبق الماضي', textAlign: TextAlign.center, style: TextStyle(fontFamily: 'Amiri', fontSize: 18, fontWeight: FontWeight.w600, color: Colors.black87)),
              ],
            ),
          ),
        ),
